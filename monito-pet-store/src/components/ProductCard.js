...
function ProductCard({ product }) {
  return (
    <div className="bg-[#FDFDFD] w-[285px] h-[490px] shadow-lg rounded-md overflow-hidden transition-shadow duration-300 hover:shadow-l p-3">
      ...
      />
      <h3 className="mt-7 text-lg font-gilroy text-[#00171F]">
        {product.name}
      </h3>
      <div className="flex items-center mt-3 mb-3">
        <p className="text-[12px] font-gilroymedium text-[#667479]">
          Product:{" "}
          <span className="font-gilroy text-[#667479]">{product.product} </span>{" "}
        </p>
        <span className="mx-4 mt-[-3px]">•</span>
        <p className="text-[12px] font-gilroymedium text-[#667479]">
          Size:{" "}
          <span className="font-gilroy text-[#667479]"> {product.size} </span>{" "}
        </p>
      </div>
      <p className="mt-2 text-[14px] font-gilroy text-[#00171F]">
        {commaintodotbyPrice(product.price)}
      </p>
      ...
      <div className="flex items-center mt-2 bg-[#FCEED5] w-[260px] h-[36px] rounded-[5px]">
        ...
        <span className="text-[#003459]text-xl mx-2">•</span>{" "}
        {/* Dot before the text */}
        <span className="text-[14px] ml-1 font-gilroy text-[#002A48]">
