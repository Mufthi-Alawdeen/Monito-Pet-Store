      ...
      <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start">
          ...
          <div className="flex space-x-2 overflow-x-auto">
            {images.map((img, idx) => (
              <div
                ...
                className={`w-[94px] h-auto rounded-lg overflow-hidden cursor-pointer ${
                  currentImage === idx ? "border-4 border-[#F1D092]" : ""
                }`}
              >
                <img
                  src={img}
        ...
        <div className="w-full lg:w-1/2 lg:pl-12 mt-6 lg:mt-0">
          ...
          <div className="flex items-center space-x-2 text-[#667479] mb-4 text-sm md:text-base">
            ...
            <svg
              className="h-3.5 w-3.5 text-gray-500 mx-1 lg:mt-[2px]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          {/* Pet Title and Price */}
          <p className="text-sm text-[#99A2A5] font-gilroymedium">
            SKU #{pet.id}
          </p>
          <h1 className="text-2xl text-[#00171F] font-gilroy mb-2">
            {pet.breed}
          </h1>
          <p className="text-xl text-[#002A48] font-gilroy mb-4">
            ...
            <table className="min-w-full text-left text-sm md:text-[14px] text-[#00171F] border-collapse">
              <tbody>
                <tr className="border-b">
                  <td className="font-gilroymedium pr-2 text-[#667479] py-2 w-32 md:w-40">
                    SKU:
                  </td>
                  <td className="font-gilroymedium text-[#667479] py-2 pl-6">
                    : #{pet.id}
                  </td>
                </tr>
                <tr className="border-b">
