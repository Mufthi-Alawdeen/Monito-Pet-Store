        ...
        {leftContent ? (
          <>
            ...
            <div className="md:w-1/2 text-left ml-16">
              ...
              <div className="flex items-center mb-2">
                <h1 className="text-[52px]  text-[#003459] font-gilroy">{title}</h1>
                {svgIcon && (
                  <img src={svgIcon} alt="SVG Icon" className="ml-3 h-[50px] w-[50px]" />
                )}
              </div>
              <h2 className="text-[36px]  text-[#003459] font-gilroy mb-4">{subtitle}</h2>
              <p className="text-[12px] text-[#242B33] font-gilroymedium mb-6">{description}</p>
              <div className="flex space-x-4 justify-start">
                <Button text={buttonText2} variant="secondary" />
                <Button text={buttonText1} variant="transparent" icon={<FaRegCirclePlay />} />
              </div>
            </div>
          ...
          <>
            ...
            <div className="md:w-1/2 text-right mr-[150px]">
              ...
              <div className="flex items-center justify-end mb-2">
                <h1 className="text-[52px] font-extrabold text-[#FDFDFD] font-gilroy">{title}</h1>
                {svgIcon && (
                  <img src={svgIcon} alt="SVG Icon" className="ml-3 h-[50px] w-[50px]" />
                )}
              </div>
              <h2 className="text-[36px] font-bold text-[#FDFDFD] font-gilroy mb-4">{subtitle}</h2>
              <div className="ml-[166px] w-[400px] h-[100px]"> 
                <p className="text-[12px] text-[#CCD1D2] font-gilroymedium mb-0">{description}</p>
              </div>
              <div className="flex space-x-4 justify-end mt-[-20px]">
                <Button text={buttonText1} variant="rightcontent" icon={<FaRegCirclePlay />} />
          ...
          <>
            ...
            <div className="md:w-1/2 text-right mr-16">
              {/* Title with SVG icon */}
              <div className="flex items-center justify-end mb-2">
                <h1 className="text-[52px] font-extrabold text-[#003459] font-gilroy">{title}</h1>
                {svgIcon && (
                  <img src={svgIcon} alt="SVG Icon" className="ml-3 h-[50px] w-[50px]" />
                )}
              </div>
              <h2 className="text-[36px] font-bold text-[#003459] font-gilroy mb-4">{subtitle}</h2>
              <div className="ml-[190px] w-[400px] h-[100px]"> 
                <p className="text-[12px] text-[#242B33] font-gilroymedium mb-2">{description}</p>
              </div>
