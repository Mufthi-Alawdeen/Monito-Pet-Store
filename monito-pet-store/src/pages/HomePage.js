...
<div className='absolute left-[calc(50%+15px)] top-[129px] transform -translate-x-1/2'>
  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-between relative z-10">
    ...
    {/* Left Column - Text */}
    <div className="md:w-1/2 mt-[-150px] relative">
      <div className="relative">
        {/* Back Rectangle */}
        <div
          className="absolute animate-slide-left left-[552px]"
          style={{
            width: '635px',
            height: '635px',
            top: '120px',
        ...
        {/* Front Rectangle */}
        <div
          className="absolute animate-slide-left delay-200 left-[620px]"
          style={{
            width: '635px',
            height: '635px',
            top: '100px',
        ...
        <img src={rec2} alt="Background shape" className="absolute -top-1 left-[15px] z-0 w-[75.1px] h-[75.1px]" />
      </div>

      <div className='ml-[25px]'>
      <h1 className="text-[60px] font-extrabold mb-4 text-[#002A48] font-gilroy leading-[68px] relative z-10">One More Friend</h1>
      <h2 className="text-[46px] text-[#002A48] mb-4 font-gilroy leading-[60px] relative z-10">Thousands More Fun!</h2>
      <p className="text-lg text-[#242B33] mb-6 font-gilroy-medium relative z-10 w-[450px]">
        Having a pet means you have more joy, a new friend, a happy person who will always be with you to have fun. We have 200+ different pets that can meet your needs!
      </p>
  

      <div className="flex space-x-4 relative z-10">
        <Button text="View Intro" variant="transparent" icon={<FaRegCirclePlay />} />
    ...
    <div className="md:w-1/2 mt-8 md:mt-0 flex justify-center relative">
      <img 
        src={petsImage}  
        alt="Person with Dog"
        className="w-[944px] h-[680px] object-cover"
      />
    </div>
  </div>
</section>
...
`}</style>
      ...
      <main className="flex flex-col items-center mr-[-75px] mt-3 ml-[-70px]">
       ...
       <div className='flex flex-row gap-[85px] p-4 justify-center ml-[25px]'>
  <img src={image11} alt="Image 1" className="w-[88px] h-[64px] " />
  <img src={image22} alt="Image 2" className="w-[114px] h-[114px] mt-[-20px]" />
...
<Labels 
  ...
  <div className="flex flex-wrap justify-between w-[1300px] ml-0 mt-[-50px] ">
    {articles.map((article, index) => (
      <div key={index} className="w-[390px] md:w-1/3 p-4">
        <div className="bg-white shadow-md rounded-lg overflow-hidden pt-[8px] pr-[8px] pl-[8px] flex flex-col h-[450px]"> {/* Set a fixed height */}
          <div className="flex justify-center">
            <img
              src={article.image}
              alt={article.title}
              className="w-[364px] h-[243px] object-cover rounded-[10px]"
            />
          </div>
          ...
          <h3 className="text-[10px] text-center font-gilroy text-[#FDFDFD]">{article.category}</h3>
          </div>
            <h3 className="text-[16px] font-gilroy text-gray-900">{article.title}</h3>
