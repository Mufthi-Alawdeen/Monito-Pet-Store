...
function Category() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      ...
      <div className="flex items-center space-x-2 text-gray-500 ml-[125px] mt-6 -mb-2 space-x-3">
  <a href="/" className="hover:text-gray-700 text-[#667479] font-gilroymedium">Home</a>
  ...
  <a href="/" className="hover:text-gray-700 text-[#667479] font-gilroymedium ">Dog</a>
  <svg className="h-3.5 w-3.5 text-gray-500 mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M9 5l7 7-7 7"></path>
  </svg>
  <span className="text-[#667479] font-medium font-gilroymedium">Small Dog</span>
</div>
  ...
  <div className="flex flex-col space-y-2">
    <label className="flex items-center space-x-3">
      ...
      />
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Male</span>
    </label>
    <label className="flex items-center space-x-3 mb-4">
      ...
      />
      <span className="text-[#00171F] mb-4 text-[14px] font-gilroymedium">Female</span>
    </label>
  </div>
</div>
  ...
  <div className="flex flex-col space-y-2">
    ...
    <label className="flex items-center space-x-3">
      ...
      />
      <span className="w-4 h-4 rounded-full bg-[#FF4D4D]"></span> {/* Small red circle */}
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Red</span>
    </label>
    ...
    <label className="flex items-center space-x-3">
      <input 
        ...
        className="appearance-none h-5 w-5 border-2 border-[#CCD1D2] rounded checked:bg-[#003459] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#003459]"
      />
      <span className="w-4 h-4 rounded-full bg-[#FFCC80]"></span> {/* Small apricot circle */}
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Apricot</span>
    </label>
    ...
    <label className="flex items-center space-x-3">
      <input 
        ...
        className="appearance-none h-5 w-5 border-2 border-[#CCD1D2] rounded checked:bg-[#003459] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#003459]"
      />
      <span className="w-4 h-4 rounded-full bg-[#2F2F2F]"></span> {/* Small black circle */}
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Black</span>
    </label>
...
<label className="flex items-center space-x-3">
  ...
  <span className="text-[#00171F] text-[14px] font-gilroymedium">Black & White</span>
</label>
    ...
    <label className="flex items-center space-x-3">
      <input 
        ...
        className="appearance-none h-5 w-5 border-2 border-[#CCD1D2] rounded checked:bg-[#003459] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#003459]"
      />
      <span className="w-4 h-4 rounded-full bg-[#C0C0C0]"></span> {/* Small silver circle */}
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Silver</span>
    </label>
    ...
    <label className="flex items-center space-x-3">
      ...
      />
      <span className="mb-4 w-4 h-4 rounded-full bg-[#FFF1CE]"></span> {/* Small tan circle */}
      <span className="mb-4 text-[#00171F] text-[14px] font-gilroymedium">Tan</span>
    </label>
  </div>
</div>
...
<div className="mb-8 shadow-[0_0.5px_0px_rgba(0,0,0,0.1)] w-[278px] mt-6">
  ...
  <div className="flex space-x-3 shadow-[0_0.5px_0px_rgba(0,0,0,0.1)]">
    ...
    <div className="relative">
      ...
      <div className="absolute inset-y-0 right-2 flex flex-col justify-center -mt-7">
        <button type="button" onClick={() => incrementValue('priceMin')} className="focus:outline-none">
          <svg width="14" height="11" viewBox="0 0 24 24" fill="none" stroke="#242B33" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
            <path d="M18 15l-6-6-6 6" />
          </svg>
        </button>
        <button type="button" onClick={() => decrementValue('priceMin')} className="focus:outline-none -mt-1">
          <svg width="14" height="11" viewBox="0 0 24 24" fill="none" stroke="#242B33" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
            <path d="M6 9l6 6 6-6" />
          </svg>
        </button>
    ...
    <div className="relative mb-8 shadow-[0_0.5px_0px_rgba(0,0,0,0.1)]">
      ...
      <div className="absolute inset-y-0 right-2 flex flex-col justify-center">
        <button type="button" onClick={() => incrementValue('priceMax')} className="focus:outline-none">
          <svg width="14" height="11" viewBox="0 0 24 24" fill="none" stroke="#242B33" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
            <path d="M18 15l-6-6-6 6" />
          </svg>
        </button>
        <button type="button" onClick={() => decrementValue('priceMax')} className="focus:outline-none -mt-1">
          <svg width="14" height="11" viewBox="0 0 24 24" fill="none" stroke="#242B33" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
            <path d="M6 9l6 6 6-6" />
          </svg>
        </button>
    ...
    <label className="flex items-center space-x-3">
      <input 
        ...
        className="appearance-none h-5 w-5 border-2 border-[#CCD1D2] rounded checked:bg-[#003459] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#003459]" // Customize border and check color
      />
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Small</span>
    </label>
    <label className="flex items-center space-x-3">
      <input 
        type="checkbox" 
        ...
        className="appearance-none h-5 w-5 border-2 border-[#CCD1D2] rounded checked:bg-[#003459] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#003459]" // Customize border and check color
      />
      <span className="text-[#00171F] text-[14px] font-gilroymedium">Medium</span>
    </label>
    <label className="flex items-center space-x-3 mb-4">
      <input 
        type="checkbox" 
        ...
        className="mb-4 appearance-none h-5 w-5 border-2 border-[#CCD1D2] rounded checked:bg-[#003459] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#003459]" // Customize border and check color
      />
      <span className="text-[#00171F] mb-4 text-[14px] font-gilroymedium">Large</span>
    </label>
  </div>
            </div>
          </aside>
  ...
  <select className="border rounded-[20px] font-gilroymedium text-[#667479] mr-[45px] p-[6px] pl-[15px] border-2 border-[#CCD1D2] w-[175px] h-full appearance-none bg-transparent">
    <option className="text-[14px] text-[#667479] font-gilroymedium">Sort by: Popular</option>
  </select>
  <div className="absolute inset-y-0 right-2 flex items-center pointer-events-none pr-[4px] mt-[4px] mr-[1px]">
    {/* Custom arrow icon */}
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M7 10L12 15L17 10" stroke="#667479" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  </div>
</div>
